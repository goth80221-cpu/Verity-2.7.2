...
local HubWindow = {}
function HubWindow.SetDraggable(b) HubState.Mode = b and "Draggable" or "Locked" hubAppearance.PositionMode = HubState.Mode end
function HubWindow.SetLocked(b) HubState.Mode = b and "Locked" or "Draggable" hubAppearance.PositionMode = HubState.Mode end
